...
export default function CreateDepartmentPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            formDataToSend.append("organization_id", formData.organization_id.toString())
            ...
            if (response.ok) {
                ...
                const data = await response.json()
                setError(data.error || data.message || "Произошла ошибка при создании отдела")
            }
        } catch (err) {
    ...
    return (
        <div className="min-h-screen mx-auto max-w-7xl">
            ...
            <div className="px-4 py-4 border-b border-gray-200">
                <h1 className="text-xl font-bold">Создание отдела</h1>
            ...
            <div className="flex-1 px-4 py-4 overflow-auto pb-20">
                {success && (
                    <div className="mb-4 p-3 bg-green-100 text-green-800 rounded-lg flex items-center">
                        ...
                        <span>Отдел успешно создан!</span>
                    </div>
                )}
                    ...
                    <div className="bg-[#f5f5f5] rounded-lg p-4 space-y-4">
                        ...
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium mb-1">
                                Название отдела <span className="text-[#e30613]">*</span>
                            </label>
                            <input
                                type="text"
                                id="name"
